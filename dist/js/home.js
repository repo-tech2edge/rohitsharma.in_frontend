...
/*** Fetch Or Static Projects */
function projects() {
    return [
        {
            id: 1,
            categories: ['Laravel', 'TailwindCSS', 'Vue'],
            url: 'https://github.com/thecodeholic/laravel-vue-survey',
            image: 'https://me.thecodeholic.com/img/survey.png',
            title: ' Full Stack app with Laravel, Tailwindcss and Vue 3',
            detail_url: 'https://github.com/thecodeholic/laravel-vue-survey'
        },
        {
            id: 2,
...
/*** Fetch Or Static Social Menus */
function socials() {
    return [
        {
            id: 1,
            url:'a',
            svg:` <svg width="10" height="18" viewBox="0 0 8 16" class="fill-current">
            <path
        ...
        },
        {
            id: 2,
            url:'#',
            svg:`<svg width="18" height="14" viewBox="0 0 16 12" class="fill-current">
            <path
        ...
        },       
        {
            id: 3,
            url:'#',
            svg:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="22px" height="22px"
            class="fill-current">
            <path
...
function menus(){
    return [
        { id: 1, title: 'Home' , link: '#home' ,target:'_self'},
        { id: 2, title: 'About', link: '#about' ,target:'_self'},
        { id: 3, title: 'Portfolio', link: '#portfolio' ,target:'_self'},
        { id: 4, title: 'Resume' , link: 'https://mailmerohit5.github.io/resume/' ,target:'_blank'},
        // <!-- { id: 5, title: 'Blog', link: '/blog' ,target:'_blank'}, -->
        { id: 6, title: 'Contact', link: '#contact' ,target:'_self'},       
    ]
}